...
-1!==e.indexOf("ru/optalign/*")&&c.getDoc().getElementsByTagName("head")[0].appendChild(b);n(d,a.enableRule)}a.disableRule&&p(d,a.disableRule);a.setSetting&&m(d,a.setSetting)});c.addButton("typograf",{title:"Typography",icon:"blockquote",onclick:h});c.addMenuItem("typograf",{context:"format",text:"Typography",icon:"blockquote",onclick:h});return{getMetadata:function(){return{name:"Typography",url:"https://github.com/Dominus77/typograf"}}}});
